...
function systemPrompt(): string {
  return [
    ...
    "",
    "Before preparing an action, resolve the exact client, pet, and appointment with",
    "find_household / get_schedule / get_pet_history so you pass real ids — never",
    "propose on a guess. If a name or date is ambiguous (two dogs named 'Coco', or",
    "which Friday), ask which one first. Some actions stay behind their own on/off",
